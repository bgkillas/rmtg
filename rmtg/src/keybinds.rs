...
impl Default for KeybindsList {
    fn default() -> Self {
        ...
        let map = enum_map! {
            ...
            Keybind::TapLeft =>     Bind::new(enum_set!(),      Menu::view_world(),         false, true,  KeyCode::KeyQ),
            Keybind::TapRight =>    Bind::new(enum_set!(),      Menu::view_world(),         false, true,  KeyCode::KeyE),
            Keybind::Transform =>   Bind::new(enum_set!(),      Menu::view_world(),         false, true,  KeyCode::KeyO),
            Keybind::Flip =>        Bind::new(enum_set!(),      Menu::view_world(),         false, true,  KeyCode::KeyF),
        };
        Self(map)
    }
}
